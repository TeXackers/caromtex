...
The \bluett{carom} package provides a new environment together with a collection of Ti\textit{k}Z macros designed to facilitate the creation of French billiards table diagrams.
