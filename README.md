...
The `carom` package provides a new environment together with a collection of Tik*Z* macros designed to facilitate the creation of French billiards table diagrams.
...
This package may be used in LaTeX by `\usepackage{carom}`.
