...
\title{The \texttt{caromtex} package}
...
The \bluett{caromtex} package provides a new environment together with a collection of Tik\textit{Z} macros designed to facilitate the creation of French billiards table diagrams.
